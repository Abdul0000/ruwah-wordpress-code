...
.rb-stage-slide{position:absolute;z-index:3;width:min(37vw,455px);height:min(53vw,590px);display:grid;place-items:center;opacity:0;visibility:hidden;transform:translateY(10px) scale(.97);transition:opacity .28s ease,transform .42s cubic-bezier(.2,.8,.2,1),visibility .28s ease}
.rb-stage-slide.is-active{opacity:1;visibility:visible;transform:none}
.rb-stage-slide a{display:grid;place-items:center;width:100%;height:100%;overflow:visible}
.rb-stage-slide img{display:block!important;width:auto!important;height:auto!important;max-width:100%!important;max-height:100%!important;object-fit:contain!important;border-radius:0!important;background:transparent!important;mix-blend-mode:multiply;filter:contrast(1.08) saturate(.95) drop-shadow(0 22px 18px rgba(0,0,0,.34));transform:none!important}
...
@media(max-width:980px){body.home .ruwa-header-inner{min-height:92px!important}.rb-stage-hero{height:650px;min-height:650px}.rb-stage-shell{grid-template-columns:82px minmax(0,1fr) 82px;grid-template-rows:76px 1fr 84px;padding-inline:14px}.rb-stage-disc{width:min(60vw,470px)}.rb-stage-slide{width:min(51vw,410px);height:min(65vw,500px)}.rb-stage-meta{font-size:10px}.rb-stage-meta-right{max-width:145px;white-space:normal}.rb-stage-arrow{width:70px}.rb-stage-cta{min-height:76px;width:min(330px,68vw)}}
@media(max-width:640px){body.home .ruwa-header-inner{min-height:76px!important}.rb-stage-hero{height:610px;min-height:610px}.rb-stage-shell{grid-template-columns:50px minmax(0,1fr) 50px;grid-template-rows:72px 1fr 76px;padding:0 8px}.rb-stage-meta{align-self:center;padding:0;font-size:8px}.rb-stage-meta-right{max-width:80px}.rb-stage-disc{width:min(78vw,360px)}.rb-stage-slide{width:min(68vw,310px);height:min(88vw,405px)}.rb-stage-arrow{width:50px;font-size:24px!important}.rb-stage-prev{justify-self:start}.rb-stage-next{justify-self:end}.rb-stage-cta{bottom:12px;width:min(260px,68vw);min-height:62px;font-size:24px}}
