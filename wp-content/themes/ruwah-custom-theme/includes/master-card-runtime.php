...
add_action('wp_enqueue_scripts', static function (): void {
    ...
    $css = '.rhp-product-badge{position:absolute!important;left:10px!important;top:10px!important;z-index:4!important;display:inline-flex!important;align-items:center!important;gap:5px!important;min-height:28px!important;padding:0 9px!important;max-width:calc(100% - 20px)!important;border:1px solid rgba(91,72,116,.16)!important;border-radius:999px!important;background:rgba(251,250,246,.94)!important;color:#211d24!important;box-shadow:0 5px 14px rgba(29,22,34,.08)!important;backdrop-filter:blur(8px)!important;-webkit-backdrop-filter:blur(8px)!important;font-size:8px!important;font-weight:700!important;line-height:1!important;letter-spacing:.07em!important;text-transform:uppercase!important;white-space:nowrap!important}.rhp-product-badge--offer:before{content:"";width:5px;height:5px;flex:0 0 5px;border-radius:50%;background:#876cad;box-shadow:0 0 0 2px rgba(135,108,173,.10)}@media(max-width:620px){.rhp-product-badge{left:8px!important;top:8px!important;gap:4px!important;min-height:25px!important;padding:0 8px!important;max-width:calc(100% - 16px)!important;font-size:7px!important;letter-spacing:.045em!important}.rhp-product-badge--offer:before{width:4px;height:4px;flex-basis:4px}}';
