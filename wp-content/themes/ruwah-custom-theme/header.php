...
<head>
    ...
    <?php wp_head(); ?>
    <style id="ruwah-reference-header-v2">
        ...
        .rb-header-brand img{display:block;width:235px;height:94px;object-fit:contain;object-position:center}
        ...
        @media(max-width:1050px){.rb-header-main{min-height:76px;grid-template-columns:auto 1fr auto;padding:0 16px}.rb-menu-btn{display:inline-flex!important;justify-self:start}.rb-header-search{display:none}.rb-header-brand{justify-self:center;width:165px;height:70px}.rb-header-brand img{width:155px;height:68px}.rb-header-tools{gap:14px}.rb-track-order{display:none!important}.rb-header-nav{display:none;position:absolute;left:0;right:0;top:76px;min-height:0;padding:14px 20px;border-top:1px solid #eee;box-shadow:0 14px 30px rgba(0,0,0,.08)}.rb-header-nav.is-open{display:block}.rb-header-nav ul{display:flex;flex-direction:column;align-items:stretch;gap:0}.rb-header-nav a{padding:12px 4px}}
        @media(max-width:760px){body.admin-bar .rb-header{top:0}.rb-header-tools .rb-account-link{display:none}.rb-header-main{min-height:70px}.rb-header-nav{top:70px}.rb-header-brand{width:138px;height:64px}.rb-header-brand img{width:130px;height:62px}}
    </style>
</head>
<body <?php body_class(); ?>>
<?php wp_body_open(); ?>
...
<header class="rb-header">
    <div class="rb-header-main">
        ...
        <a class="rb-header-brand" href="<?php echo esc_url(home_url('/')); ?>" aria-label="Ruwah Beauty home"><img src="<?php echo esc_url(get_template_directory_uri().'/assets/ruwah-header-logo.svg'); ?>" alt="Rawah Beauty"></a>
...
<aside class="rb-cart-drawer" data-cart-drawer aria-hidden="true"><header><h2>Your shopping bag</h2><button class="rb-close" type="button" data-cart-close aria-label="Close cart">×</button></header><div class="rb-cart-body widget_shopping_cart_content"><?php if (function_exists('woocommerce_mini_cart')) { woocommerce_mini_cart(); } ?></div><footer><p><?php if (!empty($progress['remaining'])) { echo 'Add '.wp_kses_post(wc_price($progress['remaining'])).' more for free shipping'; } else { echo esc_html__('You qualify for free shipping','ruwah'); } ?></p><div class="rb-progress"><i style="width:<?php echo esc_attr($progress['percent'] ?? 0); ?>%"></i></div><a class="rb-button" href="<?php echo esc_url(function_exists('wc_get_cart_url') ? wc_get_cart_url() : home_url('/cart/')); ?>">View bag &amp; checkout</a></footer></aside>
