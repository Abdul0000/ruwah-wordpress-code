...
<header class="rwb-header" data-header>
    <div class="rwb-shell rwb-header-row">
        <div class="rwb-nav-side">
            ...
            <nav class="rwb-desktop-nav" aria-label="Primary"><a href="<?php echo esc_url($shop_url); ?>">Shop</a><a href="<?php echo esc_url($learn_url); ?>">Learn</a></nav>
        </div>
...
<aside class="rwb-mobile-menu" data-menu hidden><div class="rwb-panel-head"><b>RUWAH BEAUTY</b><button class="rwb-icon" type="button" data-menu-close aria-label="Close menu">×</button></div><nav><a href="<?php echo esc_url($shop_url); ?>">Shop all</a><a href="<?php echo esc_url($learn_url); ?>">Learn</a><a href="<?php echo esc_url($account_url); ?>">My account</a></nav></aside>
