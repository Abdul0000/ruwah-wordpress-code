(()=>{
  ...
  if(body.classList.contains('home')){
    ...
    categoryStyle.textContent=`
      .home .rb-category-slider-section{padding:44px 0 50px!important;background:#fff!important;border-top:1px solid #f1e7e4!important;border-bottom:1px solid #f1e7e4!important}
      ...
      .home .rb-category-slider .rb-category-card span{position:relative!important;width:100%!important;aspect-ratio:1.34/1!important;display:flex!important;align-items:center!important;justify-content:center!important;padding:12px 12px 0!important;border:1px solid #eadfdc!important;border-radius:26px 26px 54% 54%!important;background:linear-gradient(180deg,#fff 0 22%,#f5dfb0 22% 100%)!important;box-shadow:0 8px 24px rgba(65,28,20,.055)!important;overflow:hidden!important;transition:transform .28s ease,box-shadow .28s ease!important}
      ...
      .home .rb-category-slider .rb-category-card b{display:block!important;margin-top:13px!important;color:#241d1d!important;font-family:Inter,Arial,sans-serif!important;font-size:15px!important;font-weight:650!important;line-height:1.25!important;letter-spacing:-.015em!important}
      .home .rb-category-slider .rb-category-card:hover span{transform:translateY(-4px)!important;box-shadow:0 14px 34px rgba(65,28,20,.10)!important}
      .home .rb-category-arrow{top:42%!important;width:42px!important;height:42px!important;border:1px solid #e7deda!important;background:rgba(255,255,255,.96)!important;color:#5b1624!important;font-size:25px!important;font-weight:400!important;box-shadow:0 8px 22px rgba(38,22,22,.09)!important;backdrop-filter:blur(8px)!important}
      .home .rb-category-arrow:hover{background:#5b1624!important;color:#fff!important;border-color:#5b1624!important;transform:translateY(-50%) scale(1.04)!important}
      @media(max-width:980px){
        .home .rb-category-slider{padding:0 52px!important}
        .home .rb-category-slider .rb-category-row{gap:18px!important}
        .home .rb-category-slider .rb-category-card{flex-basis:calc((100% - 36px)/3)!important}
        .home .rb-category-slider .rb-category-card span{border-radius:22px 22px 50% 50%!important}
      }
      @media(max-width:560px){
        .home .rb-category-slider-section{padding:30px 0 34px!important}
        .home .rb-category-slider{padding:0 36px!important}
        .home .rb-category-slider .rb-category-row{gap:12px!important}
        .home .rb-category-slider .rb-category-card{flex-basis:calc((100% - 12px)/2)!important;padding:0 2px 5px!important}
        .home .rb-category-slider .rb-category-card span{padding:8px 8px 0!important;border-radius:16px 16px 48% 48%!important}
        .home .rb-category-slider .rb-category-card b{margin-top:9px!important;font-size:12px!important}
        .home .rb-category-arrow{width:32px!important;height:32px!important;font-size:20px!important}
      }
    `;
