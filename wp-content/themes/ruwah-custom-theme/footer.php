...
<?php wp_footer(); ?>
<script id="rwb-footer-social-links-server">
(()=>{'use strict';const links={Facebook:'https://www.facebook.com/share/1BNAdjWpYW/',Instagram:'https://www.instagram.com/rawah.beauty?utm_source=qr&igsh=ZjMzazdrNmk1aTVt',TikTok:'https://vt.tiktok.com/ZSX6WqwS2/'};document.querySelectorAll('.rwb-dieux-footer-socials span[aria-label]').forEach(span=>{if(span.closest('a'))return;const label=span.getAttribute('aria-label')||'';const href=links[label];if(!href)return;const a=document.createElement('a');a.href=href;a.target='_blank';a.rel='noopener noreferrer';a.className='rwb-dieux-social-link';a.setAttribute('aria-label',label+' — Ruwah Beauty');a.title='Follow Ruwah Beauty on '+label;span.parentNode.insertBefore(a,span);a.appendChild(span);});})();
</script>
</body></html>